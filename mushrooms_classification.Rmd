...
## Method 
  ...
  * The ML algorithms that was chosen to model the mushroom classification data set comes from the family of **Classification Algorithms** and are : Classification trees, Random forest and K-nearest neighbors    
...
A chi square test will produce a p-value. The p-value will tell us if the test results are significant or not.
